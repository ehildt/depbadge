...
function resolveYamlMergeKey(obj) {
  if (Array.isArray(obj)) {
    return obj.map(resolveYamlMergeKey);
  }
        ...
        if (Array.isArray(merged)) {
          merged.forEach((m2) => {
            if (m2 && typeof m2 === "object") {
              Object.assign(result, resolveYamlMergeKey(m2));
            }
          });
        } else if (merged && typeof merged === "object") {
          Object.assign(result, resolveYamlMergeKey(merged));
        }
      } else {
        result[key] = resolveYamlMergeKey(value);
      }
    }
    return result;
  }
